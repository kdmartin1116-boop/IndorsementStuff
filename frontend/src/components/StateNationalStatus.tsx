    ...
    return (
        <>
            ...
            <div className="warning">
                ...
                <p>
                    <strong>Legally recognized non-citizen U.S. National status primarily applies to individuals born in or with ties to certain U.S. outlying possessions (e.g., American Samoa, Swains Island). This status is defined by U.S. law and is distinct from U.S. citizenship.</strong>
                </p>
                <p>
            ...
            <h3>1. Understanding U.S. Nationality and Citizenship</h3>
            <p>
