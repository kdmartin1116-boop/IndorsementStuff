...
def sign_as_agent(bill, agent_name, principal):
    """Adds a signature block to a bill, indicating that it was signed by an agent on behalf of a principal.

    Args:
        bill (dict): The bill to sign.
        agent_name (str): The name of the agent signing the bill.
        principal (str): The name of the principal on whose behalf the bill is being signed.

    Returns:
        dict: The bill with the signature block added.
    """
    signature_block = {
